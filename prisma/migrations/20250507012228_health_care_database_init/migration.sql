...
CREATE TABLE "medica_reports" (
    ...
    CONSTRAINT "medica_reports_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "medica_reports" ADD CONSTRAINT "medica_reports_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
